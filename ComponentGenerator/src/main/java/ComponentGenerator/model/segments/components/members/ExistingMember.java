...
//How is this different from an enum?
//Get and set?
public class ExistingMember extends Member {
    ...
    public String getFieldEntry() {
        return defaultFieldEntryForType(existingJavaType.replace("org.genevaers.repository.components.", ""));
    }
