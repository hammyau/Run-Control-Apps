...
public class ReportWriter {
    ...
    private final static String REPORT_TEMPLATE = "Engine.ftl";
	...
	public static void write(Status status){
        ...
        try {
            ...
            generateTemplatedOutput(template, nodeMap, GersConfigration.getEngineReportFileName());
            logger.atInfo().log(GersConfigration.getEngineReportFileName() +" Generated");
        } catch (IOException e) {
