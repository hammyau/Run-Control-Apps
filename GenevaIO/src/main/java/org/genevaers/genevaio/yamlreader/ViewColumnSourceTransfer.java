...
@JsonIgnoreProperties({ "environmentId", "viewId", "id", "viewColumnId", "viewSourceId", "comments", "createTime", "createBy", "modifyTime", "modifyBy"})
public class ViewColumnSourceTransfer {
