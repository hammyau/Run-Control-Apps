...
public class ViewLogicDependencyTransfer  {

	private Integer viewId; // VIEWID
	private String logicTextType; // PARENTTYPECD
	...
	public String getLogicTextType() {
		return logicTextType;
	}

	public void setLogicTextType(String logicTextType) {
