...
public class ReportWriter {
    ...
    private final static String REPORT_TEMPLATE = "Extractor.ftl";
	...
	public static void write(Status status){
        ...
        try {
            ...
            generateTemplatedOutput(template, nodeMap, GersConfigration.getExtractorReportFileName());
            logger.atInfo().log(GersConfigration.getExtractorReportFileName() +" Generated");
        } catch (IOException e) {
